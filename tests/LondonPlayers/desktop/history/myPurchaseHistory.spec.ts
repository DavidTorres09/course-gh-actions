...
test.describe('🎟️ Filters of tickets in History', () => {
  ...
  test('should display intitial  tickets when filtering by "All" states and last 30 days', async ({
    page,
  }) => {
  ...
  test('should filter tickets by date: Last 30 days', async ({ page }) => {
    ...
    // TODO: Validate dates when we have specific date
  });
  ...
  test('should search tickets by visible numbers', async ({ page }) => {
    ...
    await page.fill('.input-search-tickets', '1234');
